...
nums2 has a length of n. Example: Input: nums1 = [1,2,3,0,0,0], m = 3, nums2 =
...
class Solution {
    ...
    */
    vector<int> mergeSortedArray(vector<int>& nums1, int m, vector<int>& nums2,
                                 int n) {
...
int main() {
    ...
    int n = 3;
    vector<int> merged = s.mergeSortedArray(nums1, m, nums2, n);
    cout << "Merged Array: ";
    for (int num : merged) {
        cout << num << " ";
    }
